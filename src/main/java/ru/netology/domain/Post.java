...
public class Post {
    ...
    private RepostsInfo reportsInfo;//информация о репостах
    private ViewInfo viewsInfo;//информация о просмотрах поста
    private String typePost;//тип записи:пост, копия, ответ
    private PostSourceInfo postSource;//инфорация о способе размещения записи
    private GeoInfo geo;//информация о местоположении
